    ...
    <section className="py-20 px-6 bg-gradient-to-r from-slate-900/50 to-slate-800/50">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-accent animate-text-glow">
              {doctor.name}
            </h2>
            <div className="h-1 w-32 bg-gradient-to-r from-accent to-accent/30 mb-6 rounded-full" />
            <p className="text-sm text-accent font-semibold tracking-wider uppercase mb-6">
            ...
            <div className="flex flex-col gap-4">
              {doctor.credentials.map((credential, index) => {
                ...
                return (
                  <div key={index} className="group flex items-start gap-3 p-4 rounded-lg hover:bg-accent/10 transition-all duration-300 border border-transparent hover:border-accent/30">
